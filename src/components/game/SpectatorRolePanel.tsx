import type { Player, Spectator } from "../../core/types.ts";
...
function RoleBadge({ role }: { role: "player" | "spectator" }) {
  return (
    ...
    >
      {role === "spectator" ? "👁 Spectateur" : "🏴‍☠️ Joueur"}
    </span>
  );
}
  ...
  return (
    <div className="bg-zinc-950/40 border border-zinc-800 rounded-2xl p-4 mb-6 flex flex-col gap-2">
      ...
      <p className="text-[11px] text-zinc-400">
        {isHost
          ? "Chacun choisit son rôle. Vous pouvez seulement forcer le mode spectateur (et verrouiller) — jamais forcer le mode joueur. L'hôte reste joueur."
